...
class SunPositionFilter(HABApp.Rule):
    ...
    def __init__(self, sun_position_window: SunPositionWindow | list[SunPositionWindow], name_azimuth: str, name_elevation: str, name_input: str, name_output: str) -> None:
