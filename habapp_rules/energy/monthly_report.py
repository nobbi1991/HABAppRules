...
class EnergyShare:
    ...
    def __post_init__(self) -> None:
        ...
        try:
            ...
            raise habapp_rules.core.exceptions.HabAppRulesConfigurationException(f"The given item name is not a number item. '{self.openhab_name}'") from exc
        except HABApp.core.errors.ItemNotFoundException as exc:
            raise habapp_rules.core.exceptions.HabAppRulesConfigurationException(f"Could not find any item for given name '{self.openhab_name}'") from exc
