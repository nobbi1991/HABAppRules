...
class TimeoutList:
    ...
    def __contains__(self, item: typing.Any) -> bool:  # noqa: ANN401
    ...
    def append(self, item: typing.Any, timeout: float) -> None:  # noqa: ANN401
        """Add item to list.
    ...
    def remove(self, item: typing.Any) -> None:  # noqa: ANN401
    ...
    def pop(self, element_index: int) -> typing.Any:  # noqa: ANN401
        """Pop item from list.
