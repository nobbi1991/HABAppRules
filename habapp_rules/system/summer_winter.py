...
class SummerWinter(HABApp.Rule):
    ...
    def __init__(self, outside_temperature_name: str, summer_name: str, persistence_service: str | None = None, days: int = 5, temperature_threshold: float = 16, last_check_name: str | None = None) -> None:
