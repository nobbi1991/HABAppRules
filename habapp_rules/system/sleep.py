...
LINK_SLEEP_DEFAULT_START = datetime.time(0)
LINK_SLEEP_DEFAULT_END = datetime.time(23, 59)
...
class Sleep(habapp_rules.core.state_machine_rule.StateMachineRule):
    ...
    def __init__(self, name_sleep: str, name_sleep_request: str, name_lock: str | None = None, name_lock_request: str | None = None, name_display_text: str | None = None, name_state: str | None = None, state_label: str = "Sleep state") -> None:
