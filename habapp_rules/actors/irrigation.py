...
class Irrigation(HABApp.Rule):
    ...
    def __init__(self, name_valve: str, name_active: str, name_hour: str, name_minute: str, name_duration: str, name_repetitions: str | None = None, name_brake: str | None = None) -> None:
