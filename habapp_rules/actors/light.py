...
BrightnessTypes = list[float | bool] | float | bool
...
class _LightBase(habapp_rules.core.state_machine_rule.StateMachineRule, metaclass=abc.ABCMeta):
    ...
    def on_enter_auto_restoreState(self) -> None:
    ...
    def _get_target_brightness(self) -> bool | float | None:  # noqa: PLR0911, PLR0912
...
class _LightExtendedMixin:
    ...
    def __init__(self, config: habapp_rules.actors.config.light.LightConfigExtended, name_motion: str | None = None, door_names: list[str] | None = None) -> None:
        """Init mixin class.
