...
class TestMotion(tests.helper.test_case_base.TestCaseBase):
    ...
    def setUp(self) -> None:
        ...
        self.motion_max = habapp_rules.sensors.motion.Motion(
            "Unittest_Motion_max_raw",
            "Unittest_Motion_max_filtered",
            5,
            "Unittest_Brightness",
            "Unittest_Brightness_Threshold",
            "Unittest_Motion_max_lock",
