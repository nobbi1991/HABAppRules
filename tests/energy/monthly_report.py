...
class TestMonthlyReport(TestCaseBase):
    ...
    def test_cb_send_energy(self) -> None:
        ...
        with (
            ...
            unittest.mock.patch("habapp_rules.energy.monthly_report.create_chart") as create_chart_mock,
    ...
    def test_cb_send_energy_disabled(self) -> None:
        ...
        with (
            unittest.mock.patch("habapp_rules.energy.monthly_report.get_historic_value", side_effect=[800]),
            unittest.mock.patch("habapp_rules.energy.config.monthly_report.get_historic_value", side_effect=[90, 1000, 100]),
            unittest.mock.patch("habapp_rules.energy.monthly_report.create_chart"),
            unittest.mock.patch("habapp_rules.energy.monthly_report.create_history_chart") as create_history_chart_mock,
...
class TestMonthlyReportHistory(TestCaseBase):
    """Test _get_monthly_history."""
    ...
    def setUp(self) -> None:
        ...
        self._rule = MonthlyReport(MonthlyReportConfig(items=MonthlyReportItems(energy_sum="Energy_Sum"), parameter=MonthlyReportParameter(config_mail=mail_config, recipients=["r@r.de"])))
