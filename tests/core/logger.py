...
from habapp_rules.core.logger import InstanceLogger, setup_logger
...
class TestLoggerFunctions(unittest.TestCase):
    ...
    def test_setup_logger(self) -> None:
        ...
        with unittest.mock.patch("logging.StreamHandler", return_value=stream_handler_mock), unittest.mock.patch("habapp_rules.core.logger.MidnightRotatingFileHandler", return_value=file_handler_mock):
            setup_logger()
...
class TestInstanceLogger(unittest.TestCase):
    ...
    def test_instance_logger(self) -> None:
        ...
        instance_logger = InstanceLogger(logging.getLogger(__name__), "test_instance")
